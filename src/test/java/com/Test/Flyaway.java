...
public class Flyaway {
	public String[] exp_details() {
		...
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("reravich@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("Test123");
		driver.findElement(By.xpath("//button")).click();
		driver.findElement(By.linkText("Logout")).click();
		String exp_email = "reravich12@cisco.com";
		String exp_pwd = "Test123";
		String exp_name = "Revanth";
		String exp_adress = "Cessna Business Park";
		String exp_city = "Bangalore";
		str[0] = exp_name;
		str[1] = exp_city;
		str[2] = exp_email;
		str[3] = exp_adress;
	...
	public int Login_SearchFlight_Validate() {
		...
		driver.get("http://localhost:8080/FlyAway/");
		driver.findElement(By.linkText("Login/Signup")).click();
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("reravich12@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("Test123");
		driver.findElement(By.xpath("//button")).click();
